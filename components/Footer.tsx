...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white dark:bg-slate-800 border-t border-gray-200 dark:border-slate-700 print:hidden">
      <div className="max-w-4xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-500 dark:text-gray-400">
        ...
        <div className="flex items-center gap-x-6 order-1 sm:order-2">
            ...
            <a href="https://www.linkedin.com/company/o2graphic" target="_blank" rel="noopener noreferrer" aria-label="O2Graphic on LinkedIn" className="hover:text-blue-700 dark:hover:text-blue-500 transition-colors">
                <LinkedInIcon />
            </a>
        </div>
      </div>
