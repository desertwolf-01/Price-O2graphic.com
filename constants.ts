    ...
    options: [
      ...
      },
      {
        ...
        items: [
          ...
          'مظاريف (A4 + A3)',
          'فولدر عرض (A4 + A3)',
          'مذكرة صغيرة (5 ألوان/تصاميم)',
          'بطاقة باجة للموظفين والزوار',
          'فاتورة مخصصة + سند قبض + سند صرف',
          'تصميم أختام رسمية',
        ],
      },
      {
      ...
      },
      {
        ...
        price: 300,
        items: [
          'أقلام، أكواب، طاقية، فلاشة USB',
          'بطاقة دخول (Badge) + دبوس شعار',
          'أكياس ورقية وبلاستيكية',
          'علم الشركة + ميدالية شعار',
          'مظلف هدايا مخصص',
          'أجندة مكتبية + مفكرة جيب',
          'مظلة تحمل الشعار',
          'ميدالية مفاتيح',
        ],
      },
    ...
    options: [
      ...
      },
      {
        ...
        items: [
          ...
          'Notepad (5 colors/designs)',
          'Employee and Visitor Badges',
          'Custom Invoice + Receipt + Payment Voucher',
      ...
      },
      {
        ...
        price: 300,
        items: [
          'Pens, mugs, caps, USB flash drives',
          'Entry Badge + Pin',
          'Paper and plastic bags',
          'Company flag + Medal with logo',
          'Custom gift envelope',
          'Desk agenda + Pocket notebook',
          'Umbrella with logo',
          'Keychain',
        ],
      },
